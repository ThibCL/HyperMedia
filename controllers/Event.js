...
module.exports.getAllEventByMonth = function getAllEventByMonth (req, res, next) {
...
module.exports.getEventPresentsService = function getEventPresentsService (req, res, next) {
...
module.exports.getNextPresentsEvent = function getNextPresentsEvent (req, res, next) {
  var eventId = req.swagger.params['event-id'].value;
...
module.exports.getPreviousPresentsEvent = function getPreviousPresentsEvent (req, res, next) {
  var eventId = req.swagger.params['event-id'].value;
  var service = req.swagger.params['service'].value;
